            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    decoration: BoxDecoration(
                      color: const Color(0xFFF0FDF4), // Světle zelené pozadí
                    ...
                    child: Row(
                      ...
                      children: [
                        const Icon(Icons.notes_rounded, color: Color(0xFF16A34A), size: 16),
                        const SizedBox(width: 8),
                        Text('Otevřená otázka', style: GoogleFonts.inter(color: const Color(0xFF16A34A), fontWeight: FontWeight.w600, fontSize: 13)),
                      ],
                    ),
                  ),
                  ...
                  Container(
                    ...
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Icon(Icons.info_outline_rounded, color: Color(0xFF0056D2), size: 24),
                        const SizedBox(width: 16),
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('Vyhodnocení otevřené otázky', style: GoogleFonts.inter(fontWeight: FontWeight.w700, color: const Color(0xFF1E3A8A), fontSize: 14)),
                              ...
                              Text(
                                ...
                                style: GoogleFonts.inter(color: const Color(0xFF1E3A8A), fontSize: 13, height: 1.5)
                              ),
                            ],
                          ),
                        ),
